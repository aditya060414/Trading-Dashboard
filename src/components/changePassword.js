        ...
        <form onSubmit={handleSubmit} noValidate autoComplete="off">
          ...
          <div className="change-input-field">
            ...
            <div className="input-wrap">
              ...
              />
              {newPassword.length >= 8 && !errors.newPassword && (
                <Check size={15} className="check-icon" />
              )}
            </div>
            {errors.newPassword && (
              <p className="err-msg">{errors.newPassword}</p>
            )}
          </div>
          ...
          <div className="change-input-field">
            ...
            <div className="input-wrap">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setErrors((p) => ({ ...p, confmPassword: "" }));
                }}
                className={
                  errors.confmPassword
                    ? "error"
                    : confmPassword && confmPassword === newPassword
                      ? "valid"
                      : ""
                }
                autoComplete="new-password"
            ...
            {errors.confmPassword && (
              <p className="err-msg">{errors.confmPassword}</p>
            )}
          </div>
